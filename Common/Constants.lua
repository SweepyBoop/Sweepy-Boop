...
addon.allianceFlagIcon = "interface\\addons\\SweepyBoop\\ClassIcons\\round\\FlagCarrierHorde";
addon.hordeFlagIcon = "interface\\addons\\SweepyBoop\\ClassIcons\\round\\FlagCarrierAlliance";
