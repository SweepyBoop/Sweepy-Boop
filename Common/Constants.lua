...
addon.allianceFlagIcon = "interface\\addons\\SweepyBoop\\ClassIcons\\flag\\FlagAlliance";
addon.hordeFlagIcon = "interface\\addons\\SweepyBoop\\ClassIcons\\flag\\FlagHorde";
