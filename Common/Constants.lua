...
addon.flagCarrierHordeIcon = "interface\\addons\\SweepyBoop\\ClassIcons\\round\\FlagCarrierHorde";
addon.flagCarrierAllianceIcon = "interface\\addons\\SweepyBoop\\ClassIcons\\round\\FlagCarrierAlliance";
