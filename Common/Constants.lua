...
addon.SPEC_ICON_OVERRIDES = {
    ...
    [addon.SPECID.VENGEANCE] = GetSweepyBoopIconPath("SpecIcons", "Classicon_DemonHunter_Void"),
    ...
    [addon.SPECID.HOLY_PALADIN] = GetSweepyBoopIconPath("SpecIcons", "PALADIN_HOLY"),
    [addon.SPECID.RETRIBUTION] = GetSweepyBoopIconPath("SpecIcons", "Paladin_Retribution"),
