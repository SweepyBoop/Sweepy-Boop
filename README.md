...
- Enemy nameplate filter & highlight: customize which enemy units to hide / show / show with a pulsing icon (totem indicators); hide beast master hunters' secondary pets
