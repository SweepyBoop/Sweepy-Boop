...
An <span style="color:#36f; font-style:italic"><strong>super lightweight, easy-to-set-up</strong></span> addon to enhance arena gameplay with minimal changes to <span style="color:#36f; font-style:italic"><strong>original WoW UI</strong></span>.

Type **/sb** in game to bring up the options panel.

Default settings should work great out of the box, though each module can be toggled on/off with customization options.
