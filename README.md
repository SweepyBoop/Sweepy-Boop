...
[Open a ticket](https://github.com/SweepyBoop/Sweepy-Boop/issues/new) to report issues or request new features. You can also join my <span style="color:#36f; font-style:italic"><strong>[Discord](https://discord.gg/SMRxeZzVwc)</strong></span> to get help on addon/UI setup.
