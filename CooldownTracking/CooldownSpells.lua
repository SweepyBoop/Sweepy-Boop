...
NS.cooldownResets = {
    ...
    [1856] = {
        { spellID = 2094, amount = 30, specID = {261} }, -- Blind
        { spellID = 408, amount = 30, specID = {261} }, -- Kidney Shot
        { spellID = 212182, amount = 30, specID = {261} }, -- Smoke Bomb
        { spellID = 1766, amount = 30, specID = {261} }, -- Kick
        { spellID = 36554, amount = 30, specID = {261} }, -- Shadowstep
    },
