...
- [x] Bug fix: friendly class icon "Show CC" sometimes get stuck on the CC icon and never switches back to the class icon (mainline now only shows addon DR-listed CC auras, excluding Charge-style Blizzard pseudo CC auras)
