...
local defaults = {
    profile = {
        ...
        raidFrames = {
            ...
            raidFrameAggroHighlightAnchor = "TOPRIGHT",
            raidFrameAggroHighlightRelativePoint = "TOPRIGHT",
            raidFrameAggroHighlightGrowDirection = "LEFT",
            raidFrameAggroHighlightOffsetX = -1,
            raidFrameAggroHighlightOffsetY = -1,
