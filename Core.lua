...
local defaults = {
    profile = {
        ...
        raidFrames = {
            ...
            raidFrameAggroHighlightAnchor = "CENTER",
            raidFrameAggroHighlightRelativePoint = "TOP",
            raidFrameAggroHighlightGrowDirection = "CENTER_HORIZONTAL",
            raidFrameAggroHighlightOffsetX = 0,
            raidFrameAggroHighlightOffsetY = -9,
            raidFrameAggroHighlightSpacing = 1,
            raidFrameAggroHighlightSize = 16,
            raidFrameAggroHighlightThickness = 2,
            raidFrameAggroHighlightAlpha = 0.9,
            raidFrameAggroHighlightPulseSkullOnThreeEnemyTargeters = true,
