...
options.args.nameplatesFriendly = {
    ...
    args = {
        ...
        useFlagCarrierIcon = {
            ...
            width = "full",
            type = "toggle",
            name = addon.FORMAT_TEXTURE(addon.FLAG_CARRIER_HORDE_LOGO) .. addon.FORMAT_TEXTURE(addon.FLAG_CARRIER_ALLIANCE_LOGO) .. " Show flag carrier icons in battlegrounds",
