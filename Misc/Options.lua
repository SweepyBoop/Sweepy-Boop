            ...
            personalDR = {
                ...
                args = {
                    personalDR = {
                        ...
                        type = "toggle",
                        width = 1.2,
                        name = addon.FORMAT_TEXTURE(addon.GetSpellTexture(5384)) .. " Enabled",
                        desc = "Track diminishing returns on yourself. A pulsing Feign Death icon means you are clean on stun DR.",
                        set = function(info, val)
                            SweepyBoop.db.profile.misc[info[#info]] = val;
                            SweepyBoop.db.profile.misc.lastModified = GetTime();
