...
local function SetExpiresText()
    if ( not PVPReadyDialog ) or ( not battlefieldId ) then return end
    ...
    -- If a certain update crosses the green/yellow/red boundary, play sound
...
SweepyBoop.SetupQueueReminder = function ()
    if SweepyBoop.db.profile.misc.pvpQueueReminder and PVPReadyDialog_Display then
