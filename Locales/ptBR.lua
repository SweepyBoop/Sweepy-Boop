...
L["Toggle friendly nameplate CVars (required for class/pet icons)"] = "CVars de placas aliadas (para ícones de classe/pet)";
L["Players"] = "Jogadores";
L["Required to show class icons on friendly players."] = "Necessário para ícones de classe em jogadores aliados.";
L["Pets / minions"] = "Pets / lacaios";
L["Required to show pet icons on friendly pets and minions."] = "Necessário para ícones de pets e lacaios aliados.";
...
L["Marker"] = "Marcador";
L["Class icon + Marker"] = "Ícone de classe + marcador";
L["Marker style"] = "Estilo do marcador";
L["Double arrow"] = "Seta dupla";
L["Pin"] = "Pin";
L["Marker visibility"] = "Visibilidade do marcador";
L["Always show"] = "Mostrar sempre";
L["Party members only"] = "Apenas membros do grupo";
...
L["Swipe only"] = "Somente varredura";
L["Full"] = "Completo";
...
L["Highlight important enemy minions"] = "Invocações-chave";
...
L["Important buff alerts"] = "Alertas de bônus importantes";
...
L["Shows up to the configured number of important buffs for each arena opponent in three fixed enemy groups."] = "Mostra até o número configurado de bônus importantes para cada oponente da arena em três grupos fixos de inimigos.";
L["Max icons / enemy"] = "Máx. de ícones / inimigo";
L["Maximum number of important buff icons to show for each arena opponent."] = "Número máximo de ícones de bônus importantes a mostrar para cada oponente da arena.";
L["Maximum icons per row within each enemy group. Values above Max icons per enemy have no additional effect."] = "Número máximo de ícones por linha dentro de cada grupo de inimigos. Valores acima do máximo de ícones por inimigo não têm efeito adicional.";
L["Direction icons grow within each enemy group."] = "Direção em que os ícones crescem dentro de cada grupo de inimigos.";
L["Wrap additional rows upward instead of downward within each enemy group."] = "Organiza as linhas adicionais para cima, em vez de para baixo, dentro de cada grupo de inimigos.";
L["Show arena number"] = "Mostrar número da arena";
L["Show the arena enemy number in the group label."] = "Mostra o número do inimigo da arena no rótulo do grupo.";
L["Show the arena enemy name in the group label."] = "Mostra o nome do inimigo da arena no rótulo do grupo.";
L["Show spec"] = "Mostrar especialização";
L["Show the arena enemy specialization in the group label."] = "Mostra a especialização do inimigo da arena no rótulo do grupo.";
L["Space between icons within each enemy group."] = "Espaço entre os ícones dentro de cada grupo de inimigos.";
L["Group spacing"] = "Espaçamento entre grupos";
L["Space between arena enemy groups."] = "Espaço entre os grupos de inimigos da arena.";
L["Shows one active enemy buff that Blizzard classifies as important inside the left side of each built-in Blizzard arena frame. Blizzard decides which important buff takes priority."] = "Mostra um bônus inimigo ativo que a Blizzard classifica como importante no lado esquerdo de cada quadro de arena integrado da Blizzard. A Blizzard decide qual bônus importante tem prioridade.";
L["Position"] = "Posição";
...
L["Show large category-based aura icons beside enemy player nameplates."] = "Mostra ícones grandes de auras por categoria ao lado das barras de nome de jogadores inimigos.";
L["Show crowd control"] = "Mostrar controle coletivo";
L["Show defensives"] = "Mostrar defensivos";
L["Show important buffs"] = "Mostrar benefícios importantes";
L["Show countdown"] = "Mostrar contagem regressiva";
L["Show remaining time as countdown text on icons."] = "Mostra o tempo restante como texto de contagem regressiva nos ícones.";
L["Uses Blizzard's nameplate-important buff list instead of a custom spell list."] = "Usa a lista da Blizzard de benefícios importantes para barras de nome em vez de uma lista de feitiços personalizada.";
L["Border style"] = "Estilo da borda";
L["Plain"] = "Simples";
L["Highlight"] = "Realçado";
L["Glowing"] = "Brilhante";
L["Max icons"] = "Máximo de ícones";
L["Max icons per category"] = "Máximo de ícones por categoria";
L["Icon spacing"] = "Espaçamento dos ícones";
L["Target Name"] = "Nome do alvo";
