...
L["Highlight important enemy summons using secret-safe aura, cast, and channel presentation.\n\nThis option does not hide their health bars."] = "Destaca invocações inimigas importantes com apresentação segura de auras, conjurações e canalizações.\n\nEsta opção não oculta as barras de vida delas.";
L["Hide unimportant enemy minions in arena"] = "Ocultar lacaios inimigos sem importância na arena";
L["Hide confirmed unimportant enemy minions to reduce nameplate clutter. Currently, this applies to Demonology Warlock guardians and other non-pet minions, such as Wild Imps.\n\nDisable this to keep their health bars visible for gaining combo points or triggering effects from attacks, procs, and bleeds."] = "Oculta lacaios inimigos confirmados como sem importância para reduzir a poluição das placas. Atualmente, isso se aplica a guardiões de bruxos Demonologia e outros lacaios que não são pets, como Diabretes Selvagens.\n\nDesative esta opção para manter as barras de vida visíveis e ganhar pontos de combo ou ativar efeitos com ataques, procs e sangramentos.";
